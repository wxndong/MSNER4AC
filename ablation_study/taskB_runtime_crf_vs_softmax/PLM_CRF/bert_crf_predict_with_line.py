...
if __name__ == "__main__":
    # 配置路径
    md_dir = "../../../hy-tmp/models/Ablation_bertlr5e-5_crflr5e-3_cosine"  # 修改输出目录
    model_path = md_dir
    tokenizer_path = md_dir
    test_file = "../datasets/test/raw/testset_B.txt"  # 测试文件路径 A | B | C
    output_file = "../results/ablation_CRF_result_B.txt"  # 输出文件路径 A | B | C
